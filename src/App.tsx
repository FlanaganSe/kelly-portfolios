        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex gap-8">
              ...
              <Link href="/calculator" className="text-gray-600 hover:text-gray-900 transition-colors font-medium">
                Calculator
              </Link>
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-gray-900 font-semibold">Portfolio Optimizer</div>
                <div className="text-gray-500 text-sm">Mathematical precision for investment success</div>
              </div>
            </div>
            <div className="flex items-center gap-6">
              ...
              <div className="text-gray-500 text-sm">© 2025 Portfolio Optimizer</div>
            </div>
          </div>
        </div>
      </footer>
