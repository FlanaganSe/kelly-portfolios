        ...
        <div className="container mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex gap-8">
              <Link href="/" className="text-slate-600 hover:text-slate-900 transition-all font-medium text-lg">
                Home
              </Link>
              <Link href="/about" className="text-slate-600 hover:text-slate-900 transition-all font-medium text-lg">
                About
              </Link>
              <Link
                href="/calculator"
              ...
              <Link href="/articles" className="text-slate-600 hover:text-slate-900 transition-all font-medium text-lg">
                Articles
              </Link>
            </nav>
          </div>
