...
export const PORTFOLIOS: readonly Portfolio[] = [
  {
    ...
    tagline: "For long-term stock investing with one fund that owns the world's stock market.",
  ...
  },
  {
    ...
    tagline: "For someone willing to accept long stretches behind the market in pursuit of a value advantage.",
  ...
  },
  {
    ...
    tagline:
      "For someone who wants trend alongside stocks and accepts extra market exposure, added cost and uncertain returns.",
  ...
  },
  {
    ...
    tagline:
      "For someone seeking less stock exposure, with half the money in government bonds that can also lose value.",
