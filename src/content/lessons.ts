...
export const lessons: readonly Lesson[] = [
  ...
  },
  {
    ...
    body: "A portfolio that holds more equity, or that borrows to hold more of everything, should earn more on average. That is more beta, not alpha, and the honest comparison is against the same risk taken the simple way. Moving from 60/40 to 90/10 is worth about +127 bp a year against 485 bp of tracking error: more than all the factor leans on this site put together, and still only 92% likely to be ahead after thirty years. Anyone can do it by changing one number, which is why it does not count as an edge.",
  ...
  },
  {
    ...
    body: "Among audited US value products the exposure to HML ranges from +0.32 to +0.71 while the fee runs from 5 bp to 35 bp. A fund's cost is its fee less its securities-lending income, which reorders the shelf. IEMG costs less to own than VWO at a 50% higher fee. Buy the exposure and the cost, never the category.",
    href: "/funds",
    hrefLabel: "The shelf",
  },
  {
  ...
  },
  {
    ...
    title: "A portfolio that borrows has to be judged against a benchmark that borrows too, not against the index",
  ...
  },
  {
    ...
    body: "On this shelf 96 of 109 factor exposures survive multiple-comparison correction, and 5 of 327 alpha tests do, all five of them negative. The median alpha these windows could detect is about 5 pp/yr against roughly 1.25 pp/yr of true dispersion between funds, so most alpha findings are noise by construction. Exposure is measurable; skill is not.",
    href: "/method",
