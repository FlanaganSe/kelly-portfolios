        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 hover:bg-slate-800/60 transition-all duration-300">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              The Kelly Criterion is a mathematical formula that determines the optimal allocation of capital to
              maximize long-term growth while minimizing risk of ruin.
            </p>
