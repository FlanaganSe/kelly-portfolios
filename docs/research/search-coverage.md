...
| **Concentration** | Every sleeve tested is a diversifier or a tilt. The declared objective points the other way: under the zero-leverage rule, growth-optimal sizing returns a **corner solution** ([setting the equity share](setting-the-equity-share.md) §1.2). The objective wants concentration and the programme has only tested dilution | Nothing new |
